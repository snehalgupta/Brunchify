...
public class Tech_RV_Adapter extends RecyclerView.Adapter<Tech_RV_Adapter.ViewHolder> {
    private final ArrayList<String> interests;
    private ArrayList<String> selected_interests;
    private final Tech.OnFragmentInteractionListener mlistener;
    static final String TAG = "TechRV";
    private Context context;

    public Tech_RV_Adapter(Context cont, ArrayList<String> arr, Tech.OnFragmentInteractionListener listener){
        context = cont;
        interests = arr;
        mlistener = listener;
    ...
    @Override
    public Tech_RV_Adapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.tech_button, parent, false);
        return new Tech_RV_Adapter.ViewHolder(view, context);
    }

    @Override
    public void onBindViewHolder(final Tech_RV_Adapter.ViewHolder holder, int position) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view, Context cont) {
            super(view);
            mview = view;
            mButton = (Button) view.findViewById(R.id.tech_button);
            context = cont;
        }
